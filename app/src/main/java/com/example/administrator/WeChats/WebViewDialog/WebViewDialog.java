...
//        webView = (WebView) view.findViewById(R.id.cwv_view);
        webView = new BaseWebview(mContext);
//        webView.setTransparent(true);
//        BaseWebview.addJavascriptInterface(new JSCallNative(), "JsCallNative");
        setContentView(webView);
        setMargin();
    }

    private void setContentView(BaseWebview webView) {
        WebViewDialog.this.setContentView(webView);
    }
...
//        BaseWebview.addJavascriptInterface(mapClazz, objName);
        return this;
    }
